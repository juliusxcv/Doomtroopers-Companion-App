...
export const PERILS: Peril[] = [
  ...
  },
  {
    roll: 6,
    name: `Rift Bloom`,
    text: `A tear opens above—spilling light, voices, and unfamiliar wind. No one harmed… yet.`,
    consequence: `-1 Peril`,
  },
  {
    roll: 7,
  ...
  },
  {
    ...
    consequence: `Until their next activation, whenever the psyker is shot at, they may retain an additional dice as a safe without rolling it.`,
  },
  {
    roll: 12,
    name: `Backstep in Time`,
    text: `Psyker teleports 2" backward—no memory of having moved.`,
    consequence: `The psyker teleports 2" back in the direction they last moved from.`,
  },
  {
    roll: 13,
    name: `Soul Shear`,
  ...
  },
  {
    ...
    consequence: `Operative can not use any further actions for this activation.`,
  },
  {
    roll: 17,
    name: `Reality Snap`,
  ...
  },
  {
    ...
    consequence: `The psyker takes damage equal to the current peril gauge level.`,
  },
  {
    roll: 23,
    name: `Daemon Spawn`,
